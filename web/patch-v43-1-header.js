...
function clean(){
 ...
 if(window.TRTS_RENDER_BUILD)window.TRTS_RENDER_BUILD();else{const b=document.getElementById('trts-update'),s=b?.querySelector('span')||b;if(s&&s.textContent!=='TEST · v43.8')s.textContent='TEST · v43.8'}
}
