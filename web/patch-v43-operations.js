...
window.TRTS_OPS={dat,meta:()=>meta,points,docs,pointDocs,pointAddress,loc,facts,metrics,allocationMetrics,extraFor,extraAllocation,pointCost,displayWh,sectionKey,modal,E,F,M,M2,P,apiRange,refresh:loadRange,render:renderDashboard,screenLayout,view:v,manualCard};
