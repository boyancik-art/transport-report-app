...
for(const f of ['index.html','manifest.webmanifest','sw.js','patch-v15.js','patch-v16.js','patch-v17.js','patch-v18.js']) await copyFile(f,'dist/'+f);
...
html=html
  .replace(/<link rel="manifest" href="[^"]+">/,'<link rel="manifest" href="/manifest.webmanifest?v=19">')
  ...
  .replace('</body>','<script src="/patch-v15.js?v=19"></script><script src="/patch-v16.js?v=19"></script><script src="/patch-v17.js?v=19"></script><script src="/patch-v18.js?v=19"></script></body>');
await writeFile('dist/index.html',html);
console.log('Transport Report TS PWA v19 built');
