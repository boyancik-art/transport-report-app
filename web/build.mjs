...
for(const f of ['index.html','manifest.webmanifest','sw.js','patch-v15.js','patch-v16.js','patch-v17.js']) await copyFile(f,'dist/'+f);
...
html=html
  .replace(/<link rel="manifest" href="[^"]+">/,'<link rel="manifest" href="/manifest.webmanifest?v=18">')
  ...
  .replace('</body>','<script src="/patch-v15.js?v=18"></script><script src="/patch-v16.js?v=18"></script><script src="/patch-v17.js?v=18"></script></body>');
await writeFile('dist/index.html',html);
console.log('Transport Report TS PWA v18 built');
