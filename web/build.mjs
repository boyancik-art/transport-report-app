...
html=html
  .replace(/<link rel="manifest" href="[^"]+">/,'<link rel="manifest" href="/manifest.webmanifest?v=5">')
  .replace(/<link rel="apple-touch-icon" href="[^"]+">/,'<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png?v=5">');
await writeFile('dist/index.html',html);

console.log('Transport Report TS PWA built with true 180/192/512 icons');
