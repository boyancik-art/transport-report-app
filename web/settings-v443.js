(()=>{
 ...
 const sections=[['profile','Профіль','person'],['security','Безпека','fleet'],['theme','Тема','dashboard'],['ideas','Ідеї та побажання','bakery'],['users','Користувачі та права','person',true],['directories','Довідники','base',true],['sync','Синхронізація даних','refresh'],['audit','Журнал змін','analytics',true],['export','Експорт даних','analytics',true],['about','Про застосунок / версія','dashboard'],['logout','Вийти','logout']];
 ...
 async function render(page=''){
  ...
  else if(page==='export'&&S.isAdmin())return window.TRTS_RELEASE.exportScreen();
