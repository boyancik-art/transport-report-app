(()=>{
 ...
 function adminDelete(id){if(!TRTS_SECURITY.isAdmin())return;const host=O.view().querySelector('.v436-detail-head,.v437-detail-head');if(host&&!host.querySelector('.v443-delete')){const b=document.createElement('button');b.className='v443-delete v443-danger';b.textContent='Видалити';b.onclick=()=>window.v443DeleteRoute(id);host.append(b)}}
