...
(async()=>{
 ...
 assert.equal(await page.locator('.v436-address .v436-invoice-table').count(),0,'Route contains TT aggregates only');
 await page.locator('.v436-address-head').first().click();
 assert.equal(await page.locator('.v439-invoice').count(),2);
 assert.match(await page.locator('.v439-invoice').first().innerText(),/6136321/);
 assert.match(await page.locator('.v439-invoice').first().innerText(),/6,2/);
 await page.locator('.v43-back').click();
 ...
 assert.equal(await page.locator('#view .v436-invoice-table').count(),0);
